...
for  %%x in (service.%rev_date%.log  server.log.%rev_date%  wildfly-stderr.%rev_date%.log  wildfly-stdout.%rev_date%.log) do MOVE  %log_path%\%%x %tar_path%\%rev_date%

%path_7zip% a -tzip %tar_path%\%rev_date% %tar_path%
